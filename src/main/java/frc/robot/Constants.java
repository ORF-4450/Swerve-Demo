...
public final class Constants {
    public static String		PROGRAM_NAME = "SDT-12.12.22-1";
     ...
     */
    public static final double DRIVETRAIN_TRACKWIDTH_METERS = .475; // FIXME Measure and set trackwidth
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(145.0); // FIXME Measure and set front left steer offset
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(70); // FIXME Measure and set front right steer offset
    ...
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(58); // FIXME Measure and set back left steer offset
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(123); // FIXME Measure and set back right steer offset
}
